...
- delegation tokens in [`delegation.ts`](https://github.com/SidianLabs/micro-agent-protocol/blob/main/src/control-plane/delegation.ts)
- execution receipts in [`micro-agent.ts`](https://github.com/SidianLabs/micro-agent-protocol/blob/main/src/runtime/micro-agent.ts)
- approval-required receipts in [`orchestrator.ts`](https://github.com/SidianLabs/micro-agent-protocol/blob/main/src/control-plane/orchestrator.ts)

The signing helpers live in [`signing.ts`](https://github.com/SidianLabs/micro-agent-protocol/blob/main/src/security/signing.ts).
...
That verification happens in [`micro-agent.ts`](https://github.com/SidianLabs/micro-agent-protocol/blob/main/src/runtime/micro-agent.ts).
